...
public class TopSecretRestService extends AbstractRestService {
	...
	@POST
	@Path("/authorized")
	public Response getSecret(@FormParam("token") String token)
		...
		String output = "This is TOP secret: "
				+ configuration.getValue(Configuration.Key.TOPSECRET);
	...
	public Response authorize(@FormParam("username") String username,
		...
		URI uri = new URI("http://localhost:8080/verification.html");
